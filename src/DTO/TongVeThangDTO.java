...
public class TongVeThangDTO {
    ...
    public TongVeThangDTO() {
    }

    public TongVeThangDTO(String maVeThang, String tenKhach, String sdt, String bienSo, String loaiXe, String mauXe, LocalDate ngayDk, int soTien) {
