...
public class DangKyVeThang extends javax.swing.JFrame {
    ...
    private void themBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_themBtnActionPerformed
        ...
        TongDKVeThangDTO tk = new TongDKVeThangDTO(ticketId, customerName, phoneNumber, licensePlate, vehicleType, vehicleColor, currentDate, tien);
        ...
        billsFrame.setBillActionListener(new BillActionListener() {
            ...
            public void onConfirm(VeThangDTO ticket) {
                VeThangDAO.insert(ticket); // Lưu vào database
                showData(); // Hiển thị lại dữ liệu
                lammoiBtnActionPerformed(evt); // Làm mới các trường nhập liệu
            }

            @Override
            public void onCancel() {
                // Người dùng hủy, không cần làm gì
            }
        });
